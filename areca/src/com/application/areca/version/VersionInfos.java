...
public class VersionInfos {
	...
	static {
		...
		BUILD_ID = 5517812712565341107L;

		// INIT VERSION DATA
		VERSIONS.add(new VersionData("7.1.3", new GregorianCalendar(2009, 6, 5), "Regular expression filter bug fix; Minor XML configuration bug fix."));

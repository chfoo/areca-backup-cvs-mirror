...
public class TargetXMLWriter extends AbstractXMLWriter {
    ...
    public void serializeTarget(FileSystemTarget tg) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(tg.getId()));
        
        sb.append(" ");
        sb.append(XML_TARGET_UID);
        sb.append("=");
        sb.append(XMLTool.encode(tg.getUid()));
        
        sb.append(" ");
        sb.append(XML_TARGET_FOLLOW_SYMLINKS);
        sb.append("=");
        sb.append(XMLTool.encode(! tg.isTrackSymlinks()));
        
        sb.append(" ");
        sb.append(XML_TARGET_TRACK_EMPTY_DIRS);
        sb.append("=");
        sb.append(XMLTool.encode(tg.isTrackEmptyDirectories()));
        
        sb.append(" ");
        sb.append(XML_TARGET_FOLLOW_SUBDIRECTORIES);
        sb.append("=");
        sb.append(XMLTool.encode(tg.isFollowSubdirectories()));
        
        sb.append(" ");
        sb.append(XML_TARGET_CREATE_XML_SECURITY_COPY);
        sb.append("=");
        sb.append(XMLTool.encode(tg.isCreateSecurityCopyOnBackup()));
        
        sb.append(" ");
        sb.append(XML_TARGET_NAME);
        sb.append("=");
        sb.append(XMLTool.encode(tg.getTargetName()));     
        
        sb.append(" ");
        sb.append(XML_TARGET_DESCRIPTION);
        sb.append("=");
        sb.append(XMLTool.encode(tg.getComments()));     
    ...
    protected void serializeSource(File source) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(FileSystemManager.getAbsolutePath(source)));
        sb.append("/>");     
    }
    ...
    protected void serializeProcessorHeader(String header, boolean postProcess, Processor proc) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(postProcess));  
        sb.append(" "); 
        sb.append(XML_PP_RUN_SUCCESS);
        sb.append("=");
        sb.append(XMLTool.encode(proc.isRunIfOK()));  
        sb.append(" "); 
        sb.append(XML_PP_RUN_ERROR);
        sb.append("=");
        sb.append(XMLTool.encode(proc.isRunIfError()));  
        sb.append(" "); 
        sb.append(XML_PP_RUN_WARNING);
        sb.append("=");
        sb.append(XMLTool.encode(proc.isRunIfWarning()));  
        sb.append(" "); 
    }
    ...
    protected void serializeProcessor(FileDumpProcessor pp, boolean postProcess) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(FileSystemManager.getAbsolutePath(pp.getDestinationFolder())));
        sb.append(" ");     
        sb.append(XML_PP_DUMP_NAME);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getReportName()));  
        sb.append("/>");        
    }
    ...
    protected void serializeProcessor(MergeProcessor pp, boolean postProcess) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(pp.getFromDelay()));
        sb.append(" ");
        sb.append(XML_PP_MERGE_TO_DELAY);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getToDelay()));
        sb.append(" ");
        sb.append(XML_PP_MERGE_KEEP_DELETED);
        sb.append("=");
        sb.append(XMLTool.encode(pp.isKeepDeletedEntries()));
        sb.append("/>");        
    }
    ...
    protected void serializeProcessor(DeleteProcessor pp, boolean postProcess) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(pp.getDelay()));
        sb.append("/>");        
    }
    ...
    protected void serializeProcessor(MailSendProcessor pp, boolean postProcess) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(pp.getRecipients()));
        sb.append(" ");
        sb.append(XML_PP_EMAIL_SMTP);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getSmtpServer()));
        sb.append(" ");
        sb.append(XML_PP_EMAIL_USER);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getUser()));      
        sb.append(" ");
        sb.append(XML_PP_EMAIL_PASSWORD);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getPassword()));  
        sb.append(" ");        
        sb.append(XML_PP_EMAIL_SMTPS);
        sb.append("=");
        sb.append(XMLTool.encode(pp.isSmtps()));    
        sb.append(" ");
        sb.append(XML_PP_EMAIL_TITLE);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getTitle()));   
        sb.append(" ");
        sb.append(XML_PP_EMAIL_FROM);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getFrom()));   
        sb.append(" ");
        sb.append(XML_PP_EMAIL_INTRO);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getIntro())); 
        sb.append("/>");        
    }
    ...
    protected void serializeProcessor(ShellScriptProcessor pp, boolean postProcess) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(pp.getCommand()));
        sb.append(" ");
        sb.append(XML_PP_SHELL_PARAMS);
        sb.append("=");
        sb.append(XMLTool.encode(pp.getCommandParameters()));
        sb.append("/>");        
    }
    ...
    protected void serializeFilter(FilterGroup filters) {
        ...
        sb.append("=");
        sb.append(XMLTool.encode(filters.isLogicalNot()));
        sb.append(" ");
        sb.append(XML_FILTER_GROUP_OPERATOR);
        sb.append("=");
        sb.append(XMLTool.encode(filters.isAnd() ? XML_FILTER_GROUP_OPERATOR_AND : XML_FILTER_GROUP_OPERATOR_OR));
        sb.append(" ");
        sb.append(">");             
